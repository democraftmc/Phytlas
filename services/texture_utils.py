...
def ensure_placeholder_texture(target: Path) -> None:
    """
    Create a white 16x16 placeholder texture if it doesn't exist.

    Args:
        target: Path where the placeholder texture should be created.

    Returns:
        None. Creates the texture file if needed.
